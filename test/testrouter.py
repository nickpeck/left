...
class TestRouter(unittest.TestCase):
    ...
    def test_handle_route_change(self):
        ...
        page.go = mock.Mock()
        page.views = []
        router = LeftRouter(page)
        router.on_route_change = mock.Mock()
        page.on_route_change(ft.RouteChangeEvent(route="/new/route"))
        assert router.on_route_change.call_args == mock.call(['new', 'route'])
    ...
    def test_handle_view_pop(self):
        ...
        assert page.go.call_args == mock.call("/earlier-route")
